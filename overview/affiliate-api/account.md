...
```bash
curl -X GET -H "X-Api-Key: {key}" -H "Cache-Control: no-cache" -H "Postman-Token: c5d70184-208f-4423-6003-9e30f38c5087" "https://api.trackier.com/affiliate/account"
```
...
}' "https://api.trackier.com/affiliate/account"
```
